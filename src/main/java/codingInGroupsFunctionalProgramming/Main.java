...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        TrainerDatabase trainerDatabase = new TrainerDatabase();
        StudentDatabase studentDatabase = new StudentDatabase();
        GroupSortingService groupSortingService = new GroupSortingService();

        studentDatabase.constructStudentList();
        trainerDatabase.constructTrainerList();
        groupDatabase.constructGroups();



       // GroupDatabase.constructStudentGroup();



        GroupSortingService.lastNameSortAlphabeticly(GroupDatabase.getGroupList());


        System.out.println(groupSortingService.groupWithMaxNumberOfStudents(GroupDatabase.getGroupList()));


    //    groupDatabase.studentsYoungerThan25(GroupDatabase.getGroupList());
